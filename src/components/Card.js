...
import PokeBall from './card-images/Poké_Ball_icon.svg';
...
const CardBack = () => {
  return (
    <div className="rounded-[30px] shadow-2xl bg-white max-w-sm">
      <div className="mx-auto border-2 border-black bg-amber-300 p-10 rounded-t-[30px] min-h-[384px] min-w-[384px]">
        <img className="rounded-t-lg m-auto" src={PokeBall} alt="" />
      </div>
      <div className="p-6 relative border-solid border-2 border-black rounded-b-[30px] min-h-[252px]">
        <p className="text-center text-5xl font-bold mt-[70px]">'POKE FIGTH'</p>
      </div>
    </div>
  );
};
