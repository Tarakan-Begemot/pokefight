...
const PokeList = ({ localDex, inputName }) => {
  ...
  return (
    <div className="text-gray-900 bg-white rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white my-2 mx-[50px] overflow-auto max-h-[536px]">
